...
class MyNode(Node):
    ...
    def on_timer(self):
        ...
        try:
            ...
            print("vel x:" + str(msg.twist.linear.x ))
            print("vel z:" + str(msg.twist.angular.z ))
            if dir > 0.1:
    ...
    def goal_callback(self, msg):
        ...
        #self.pub.publish(msg)
        print("Chegou aqui")
        print("point to go x:" + str(msg.x ))
        print("point to go y:" + str(msg.y ))
        ...
        if False:
            ...
            try:
                ...
                print("go x = " + str(self.goal.x))
                print("go y = " + str(self.goal.y))
            except Exception as e:
                print("Ocorru um erro: " + str(e))
                return
